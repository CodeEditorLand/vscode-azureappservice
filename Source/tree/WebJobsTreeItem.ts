...
export class WebJobsTreeItem extends AzExtParentTreeItem {
	public static contextValue = "webJobs";
...
export class WebJobsNATreeItem extends NotAvailableTreeItem {
	public static contextValue = "webJobsNA";
	public readonly label: string = label;
	...
	public async loadMoreChildrenImpl(
		...
		return [
			new GenericTreeItem(this, {
				label: localize(
					"webJobNA",
					"WebJobs are not available for Linux Apps.",
				),
				contextValue: "webJobNA",
			}),
		];
	}
}
