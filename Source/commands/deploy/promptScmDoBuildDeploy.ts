...
export async function promptScmDoBuildDeploy(
	...
	const buildDuringDeploy: string = localize(
		"buildDuringDeploy",
...
export async function enableScmDoBuildDuringDeploy(
	...
	const zipIgnoreFolders: string[] = await getIgnoredFoldersForDeployment(
		fsPath,
		runtime
	);
